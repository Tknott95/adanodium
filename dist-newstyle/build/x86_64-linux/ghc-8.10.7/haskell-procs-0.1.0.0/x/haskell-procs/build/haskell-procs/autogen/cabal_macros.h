...
/* package haskell-procs-0.1.0.0 */
#ifndef VERSION_haskell_procs
#define VERSION_haskell_procs "0.1.0.0"
#endif /* VERSION_haskell_procs */
#ifndef MIN_VERSION_haskell_procs
#define MIN_VERSION_haskell_procs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_procs */
...
#define CURRENT_COMPONENT_ID "haskell-procs-0.1.0.0-inplace-haskell-procs"
